...
const Toggle = ({ checked, onChange, color = 'bg-indigo-600' }) => (
  <button
    type="button"
                    ...
                    return (
                      <div
                        ...
                        className={cn(
                          ...
                          reply.is_active ? 'border-indigo-200 bg-indigo-50/40' : 'border-slate-100 bg-slate-50/30'
                        )}
                      >
