      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-8">
        {isLoading ? (
          <div className="col-span-full py-20 text-center">
            <Loader2 className="animate-spin text-indigo-600 h-10 w-10 mb-4 mx-auto" />
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-2">
                  <span className={cn(
                    ...
                    statusMap[number.status]?.color || 'text-slate-600 bg-slate-100'
                  )}>
                    {statusMap[number.status]?.label || number.status}
                  </span>
                </div>
              </div>
        ...
        <div className="bg-indigo-600 p-6 lg:p-10 rounded-2xl lg:rounded-[2rem] shadow-2xl text-white relative flex flex-col items-center justify-center text-center overflow-hidden group min-h-[200px]">
          ...
          <div className="relative z-10">
            ...
            <p className="text-indigo-100 text-sm font-medium leading-relaxed max-w-[200px]">
              جميع الأرقام مرتبطة بنظام حظر ذكي يضمن أمان حساباتك الرسمية بالواتساب.
            </p>
