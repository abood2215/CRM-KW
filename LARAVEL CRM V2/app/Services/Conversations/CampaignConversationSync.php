...
class CampaignConversationSync
{
    ...
    public function recordSend(Contact $contact, Campaign $campaign, string $content, ?string $waMessageId, ?string $mediaUrl = null, ?int $whatsappNumberId = null): void
    {
        ...
        $this->conversations->recordOutboundMessage($conversation, $content, $waMessageId, $campaign->name, $mediaUrl, $whatsappNumberId);
    }
}
