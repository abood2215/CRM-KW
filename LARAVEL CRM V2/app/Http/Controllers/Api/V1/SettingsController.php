...
class SettingsController extends Controller
{
    ...
    {
        return response()->json(['business_hours' => BusinessHour::orderBy('day_of_week')->get()]);
    }
    ...
    public function updateBusinessHours(Request $request): JsonResponse
    {
        ...
        $request->merge(['hours' => $normalized]);
        ...
        foreach ($request->hours as $hour) {
            BusinessHour::updateOrCreate(
                ...
                ['start_time' => $hour['start_time'], 'end_time' => $hour['end_time'], 'is_active' => $hour['is_active']],
            );
        }
    ...
    {
        return response()->json(['auto_replies' => AutoReply::all()]);
    }
    ...
    public function updateAutoReplies(Request $request): JsonResponse
    {
        ...
        foreach ($request->replies as $reply) {
            AutoReply::updateOrCreate(
                ...
                ['message' => $reply['message'], 'is_active' => $reply['is_active']],
            );
        }
